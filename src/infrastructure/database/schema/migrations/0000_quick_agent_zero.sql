...
CREATE TABLE `mailerIdentities` (
	...
	`MailerIdentityStatus` enum('PENDING','APPROVED','DENIED','FAILED','TEMPORARILY_FAILED'),
	`configuration` json,
...
CREATE TABLE `mailers` (
	...
	`MailerStatus` enum('READY','PENDING','INSTALLING','CREATING_IDENTITIES','SENDING_TEST_EMAIL','DISABLED','ACCESS_KEYS_LOST_PROVIDER_ACCESS'),
