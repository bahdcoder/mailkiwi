...
import { icons } from '#root/build/core/pages/w/(products)/engage/flows/@uuid/composer/automation-flow/components/add-node-dialog.js'
import type { PropsWithChildren } from 'react'
import type { AutomationStep } from '#root/database/database_schema_types.js'
import { Text } from '@kibamail/owly/text'
import { nodeLabels } from '#root/build/core/pages/w/(products)/engage/flows/@uuid/composer/automation-flow/nodes/skeleton_node.js'
