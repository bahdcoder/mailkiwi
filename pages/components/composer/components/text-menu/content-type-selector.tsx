import { ContentPickerOptions } from "@/pages/components/composer/types/content-types.js"
  ...
  return (
    <Dropdown.Root>
      <Dropdown.Trigger asChild>
        <button className="flex items-center justify-center gap-1 transition-colors duration-100 ease-in-out h-6 text-[var(--content-tertiary-inverse)] hover:bg-white hover:text-white hover:bg-opacity-[0.08] rounded-md">
          {activeItem?.icon}
